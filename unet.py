"""Code modified from MIT licensed https://github.com/zhixuhao/unet"""
...
def get_unet(pretrained_weights=None, input_size=(256, 256, 1)):
    ...
    up6 = tfkl.Conv2D(512, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        tfkl.UpSampling2D(size=(2, 2))(drop5))
    ...
    up7 = tfkl.Conv2D(256, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        tfkl.UpSampling2D(size=(2, 2))(conv6))
    ...
    up8 = tfkl.Conv2D(128, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        tfkl.UpSampling2D(size=(2, 2))(conv7))
    ...
    up9 = tfkl.Conv2D(64, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        tfkl.UpSampling2D(size=(2, 2))(conv8))
    ...
    conv10 = tfkl.Conv2D(1, 1, activation='sigmoid')(conv9)
